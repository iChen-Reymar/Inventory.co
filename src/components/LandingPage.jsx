...
function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="px-5 py-2.5 bg-gradient-to-r from-blue-600 to-cyan-500 text-white font-semibold rounded-xl hover:from-blue-500 hover:to-cyan-400 transition-all shadow-lg shadow-blue-500/25 hover:shadow-blue-500/40 hover:scale-105"
            >
              Sign Up
            </button>
          </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/10 border border-blue-500/20 rounded-full mb-8 animate-pulse">
            ...
            <span className="text-blue-300 text-sm font-medium">Now with AI-Powered Insights</span>
          </div>
          ...
          {/* Subtitle */}
          <p className="text-xl text-blue-100/70 max-w-2xl mx-auto mb-12 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            <button
              onClick={() => navigate('/signup')}
              className="group px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-500 text-white text-lg font-bold rounded-2xl hover:from-blue-500 hover:to-cyan-400 transition-all shadow-2xl shadow-blue-500/30 hover:shadow-blue-500/50 hover:scale-105 flex items-center gap-3"
            >
              Get Started Free
            ...
            <button
              ...
              className="px-8 py-4 bg-white/5 border border-white/10 text-white text-lg font-medium rounded-2xl hover:bg-white/10 transition-all flex items-center gap-3"
            >
              Learn More
      ...
      {/* How It Works */}
      <section className="relative py-24 bg-gradient-to-b from-transparent via-blue-950/50 to-transparent">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              How It Works
      ...
      <section className="relative py-24">
        <div className="max-w-4xl mx-auto px-6">
          <div className="relative p-12 bg-gradient-to-br from-blue-600/20 to-cyan-600/20 border border-blue-500/20 rounded-3xl backdrop-blur-xl text-center overflow-hidden">
            {/* Decorative elements */}
            ...
            <p className="relative text-xl text-blue-100/70 mb-8 max-w-xl mx-auto">
              Join thousands of businesses using Inventory.co to manage their products and grow their revenue.
            </p>
            <button
              onClick={() => navigate('/signup')}
              className="relative px-8 py-4 bg-white text-blue-600 text-lg font-bold rounded-2xl hover:bg-blue-50 transition-all shadow-2xl hover:scale-105"
            >
              Start Free Trial →
            </button>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <span className="text-lg font-bold text-white">Inventory.co</span>
            </div>
            <p className="text-blue-100/40 text-sm">
              © 2024 Inventory.co. All rights reserved.
            </p>
            <div className="flex items-center gap-6">
              <a href="#" className="text-blue-100/60 hover:text-white transition-colors text-sm">Privacy</a>
              <a href="#" className="text-blue-100/60 hover:text-white transition-colors text-sm">Terms</a>
              <a href="#" className="text-blue-100/60 hover:text-white transition-colors text-sm">Contact</a>
            </div>
          </div>
        </div>
      </footer>
